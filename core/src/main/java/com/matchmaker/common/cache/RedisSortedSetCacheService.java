...
import com.matchmaker.common.cache.dto.RedisSortedSetCacheValue;
 ...
 */
public abstract class RedisSortedSetCacheService<K, V extends RedisSortedSetCacheValue> extends RedisAbstractCacheService<K, Collection<V>> {

    Logger logger = LogManager.getLogger(RedisSortedSetCacheService.class);
